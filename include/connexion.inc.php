        ...
        if($check){
            if($donnee = $req->fetch()){
                if($pass == $donnee['PASSWORD']){
                    ...
                    echo "</br><div class='container col-md-4 col-md-offset-4'><div class='alert alert-danger' style='text-align: center;'> <strong>Attention !</strong> Mauvais identifiants. </div></div>";
            }
            else                
                echo "</br><div class='container col-md-4 col-md-offset-4'><div class='alert alert-danger' style='text-align: center;'> <strong>Attention !</strong> Mauvais identifiants. </div></div>";        
        }
